...
contains
  ...
  subroutine ncwrt_bgc(iogrp)
    ...
    use mo_bgcmean,     only: domassfluxes,flx_ndepnoy,flx_tdust,flx_sfe,flx_oalk,                 &
                              ...
                              lyr_prefdoc,lyr_prefdocsl,lyr_prefdocsr,lyr_prefdocr,                &
                              lvl_dic,lvl_alkali,                                                  &
                              ...
                              lvl_prefdoc,lvl_prefdocsl,lvl_prefdocsr,lvl_prefdocr,                &
                              ...
                              jatmco2,jatmn2,jatmo2,srf_atmo2,srf_atmn2,jtdoc_lc,jtdoc_hc,         &
                              lyr_tdoc_lc,lyr_tdoc_hc,lvl_tdoc_lc,lvl_tdoc_hc,jlvltdoc_lc,         &
                              jlvltdoc_hc,jtdoc_lc13,jtdoc_hc13,lyr_tdoc_lc13,lyr_tdoc_hc13,       &
                              lvl_tdoc_lc13,lvl_tdoc_hc13,jlvltdoc_lc13,jlvltdoc_hc13,             &
    ...
    datenum=time-time0-0.5_rp*diagfq_bgc(iogrp)/nstep_in_day
    ...
    rnacc=1._rp/real(nacc_bgc(iogrp))
    ...
    dummy = 0
    if (cmpflg.ne.0) then
      call ncwrtr('plon','pcomp',plon(1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy),dummy,0,1._rp,0._rp,8)
      call ncwrtr('plat','pcomp',plat(1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy),dummy,0,1._rp,0._rp,8)
    else
    ...
    if (use_cisonew) then
      ...
      if (use_river2omip) then
        call finlyr(jtdoc_lc13(iogrp),jdp(iogrp))
        call finlyr(jtdoc_hc13(iogrp),jdp(iogrp))
      endif
    endif
    if (use_AGG) then
    ...
    if (use_DOMclasses .and. use_pref_tracers) then
      ...
      call finlyr(jprefdocr(iogrp),jdp(iogrp))
    endif
    ...
    call wrtsrf(jkwco2sol(iogrp),    SRF_KWCO2SOL(iogrp), rnacc,              0._rp,cmpflg,'kwco2sol')
    call wrtsrf(jco2sol(iogrp),      SRF_CO2SOL(iogrp),   rnacc,              0._rp,cmpflg,'co2sol')
    call wrtsrf(jfco2(iogrp),        SRF_FCO2(iogrp),     rnacc,              0._rp,cmpflg,'fco2')
    call wrtsrf(jpco2(iogrp),        SRF_PCO2(iogrp),     rnacc,              0._rp,cmpflg,'pco2')
    call wrtsrf(jxco2(iogrp),        SRF_XCO2(iogrp),     rnacc,              0._rp,cmpflg,'xco2')
    call wrtsrf(jpco2_gex(iogrp),    SRF_PCO2_GEX(iogrp), rnacc,              0._rp,cmpflg,'pco2_gex')
    call wrtsrf(jdmsflux(iogrp),     SRF_DMSFLUX(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dmsflux')
    call wrtsrf(jco2fxd(iogrp),      SRF_CO2FXD(iogrp),   rnacc*12._rp/dtbgc, 0._rp,cmpflg,'co2fxd')
    call wrtsrf(jco2fxu(iogrp),      SRF_CO2FXU(iogrp),   rnacc*12._rp/dtbgc, 0._rp,cmpflg,'co2fxu')
    call wrtsrf(joxflux(iogrp),      SRF_OXFLUX(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'fgo2')
    call wrtsrf(jniflux(iogrp),      SRF_NIFLUX(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'fgn2')
    call wrtsrf(jn2ofx(iogrp),       SRF_N2OFX(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'n2oflux')
    call wrtsrf(jsrfpn2om(iogrp),    SRF_PN2OM(iogrp),    rnacc,              0._rp,cmpflg,'pn2om')
    call wrtsrf(jdms(iogrp),         SRF_DMS(iogrp),      rnacc,              0._rp,cmpflg,'dms')
    call wrtsrf(jdmsprod(iogrp),     SRF_DMSPROD(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dmsprod')
    call wrtsrf(jdms_bac(iogrp),     SRF_DMS_BAC(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dms_bac')
    call wrtsrf(jdms_uv(iogrp),      SRF_DMS_UV(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dms_uv')
    call wrtsrf(jexport(iogrp),      SRF_EXPORT(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'epc100')
    call wrtsrf(jexposi(iogrp),      SRF_EXPOSI(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'epsi100')
    call wrtsrf(jexpoca(iogrp),      SRF_EXPOCA(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'epcalc100')
    call wrtsrf(jsrfdic(iogrp),      SRF_DIC(iogrp),      rnacc*1.e3_rp,      0._rp,cmpflg,'srfdissic')
    call wrtsrf(jsrfalkali(iogrp),   SRF_ALKALI(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'srftalk')
    call wrtsrf(jsrfphosph(iogrp),   SRF_PHOSPH(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'srfpo4')
    call wrtsrf(jsrfoxygen(iogrp),   SRF_OXYGEN(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'srfo2')
    call wrtsrf(jsrfano3(iogrp),     SRF_ANO3(iogrp),     rnacc*1.e3_rp,      0._rp,cmpflg,'srfno3')
    ...
    call wrtsrf(jtdustfx(iogrp),     FLX_TDUST(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'tdustfx')
    call wrtsrf(jsfefx(iogrp),       FLX_SFE(iogrp),      rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sfefx')
    call wrtsrf(joalkfx(iogrp),      FLX_OALK(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'oalkfx')
    call wrtsrf(jcarflx0100(iogrp),  FLX_CAR0100(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'carflx0100')
    call wrtsrf(jcarflx0500(iogrp),  FLX_CAR0500(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'carflx0500')
    call wrtsrf(jcarflx1000(iogrp),  FLX_CAR1000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'carflx1000')
    call wrtsrf(jcarflx2000(iogrp),  FLX_CAR2000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'carflx2000')
    call wrtsrf(jcarflx4000(iogrp),  FLX_CAR4000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'carflx4000')
    call wrtsrf(jcarflx_bot(iogrp),  FLX_CAR_BOT(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'carflx_bot')
    call wrtsrf(jbsiflx0100(iogrp),  FLX_BSI0100(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'bsiflx0100')
    call wrtsrf(jbsiflx0500(iogrp),  FLX_BSI0500(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'bsiflx0500')
    call wrtsrf(jbsiflx1000(iogrp),  FLX_BSI1000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'bsiflx1000')
    call wrtsrf(jbsiflx2000(iogrp),  FLX_BSI2000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'bsiflx2000')
    call wrtsrf(jbsiflx4000(iogrp),  FLX_BSI4000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'bsiflx4000')
    call wrtsrf(jbsiflx_bot(iogrp),  FLX_BSI_BOT(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'bsiflx_bot')
    call wrtsrf(jcalflx0100(iogrp),  FLX_CAL0100(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'calflx0100')
    call wrtsrf(jcalflx0500(iogrp),  FLX_CAL0500(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'calflx0500')
    call wrtsrf(jcalflx1000(iogrp),  FLX_CAL1000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'calflx1000')
    call wrtsrf(jcalflx2000(iogrp),  FLX_CAL2000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'calflx2000')
    call wrtsrf(jcalflx4000(iogrp),  FLX_CAL4000(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'calflx4000')
    call wrtsrf(jcalflx_bot(iogrp),  FLX_CAL_BOT(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'calflx_bot')
    call wrtsrf(jdustflx0100(iogrp), FLX_DUST0100(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dustflx0100')
    call wrtsrf(jdustflx0500(iogrp), FLX_DUST0500(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dustflx0500')
    call wrtsrf(jdustflx1000(iogrp), FLX_DUST1000(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dustflx1000')
    call wrtsrf(jdustflx2000(iogrp), FLX_DUST2000(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dustflx2000')
    call wrtsrf(jdustflx4000(iogrp), FLX_DUST4000(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dustflx4000')
    call wrtsrf(jdustflx_bot(iogrp), FLX_DUST_BOT(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'dustflx_bot')
    call wrtsrf(jzeunutlim_fe(iogrp),ZEU_NUTLIM_FE(iogrp),rnacc,              0._rp,cmpflg,'zeu_nlim_fe')
    call wrtsrf(jzeunutlim_phosph(iogrp), ZEU_NUTLIM_PHOSPH(iogrp), rnacc,    0._rp,cmpflg,'zeu_nlim_po4')
    call wrtsrf(jzeunutlim_n(iogrp), ZEU_NUTLIM_N(iogrp), rnacc,              0._rp,cmpflg,'zeu_nlim_n')
    if (.not. use_sedbypass) then
      call wrtsrf(jsediffic(iogrp),    FLX_SEDIFFIC(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfdic')
      call wrtsrf(jsediffal(iogrp),    FLX_SEDIFFAL(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfalk')
      call wrtsrf(jsediffph(iogrp),    FLX_SEDIFFPH(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfpho')
      call wrtsrf(jsediffox(iogrp),    FLX_SEDIFFOX(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfox')
      call wrtsrf(jsediffn2(iogrp),    FLX_SEDIFFN2(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfn2')
      call wrtsrf(jsediffno3(iogrp),   FLX_SEDIFFNO3(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfno3')
      call wrtsrf(jsediffsi(iogrp),    FLX_SEDIFFSI(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfsi')
      call wrtsrf(jburflxsso12(iogrp), FLX_BURSSO12(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'burfsso12')
      call wrtsrf(jburflxsssc12(iogrp),FLX_BURSSSC12(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'burfsssc12')
      call wrtsrf(jburflxssssil(iogrp),FLX_BURSSSSIL(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'burfssssil')
      call wrtsrf(jburflxssster(iogrp),FLX_BURSSSTER(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'burfssster')
      if (use_extNcycle) then
        call wrtsrf(jsediffnh4(iogrp),   FLX_SEDIFFNH4(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfnh4')
        call wrtsrf(jsediffn2o(iogrp),   FLX_SEDIFFN2O(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfn2o')
        call wrtsrf(jsediffno2(iogrp),   FLX_SEDIFFNO2(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sedfno2')
      endif
      if (use_sediment_quality) then
        call wrtsrf(jsed_mavg_prorca(iogrp),SDM_MAVG_prorca(iogrp),rnacc,0._rp,cmpflg,'sedmavgprorca')
      endif
    endif
    if (use_cisonew) then
      call wrtsrf(jco213fxd(iogrp),    SRF_CO213FXD(iogrp), rnacc*12._rp/dtbgc,       0._rp,cmpflg,'co213fxd')
      call wrtsrf(jco213fxu(iogrp),    SRF_CO213FXU(iogrp), rnacc*12._rp/dtbgc,       0._rp,cmpflg,'co213fxu')
      call wrtsrf(jco214fxd(iogrp),    SRF_CO214FXD(iogrp), rnacc*12._rp*c14fac/dtbgc,0._rp,cmpflg,'co214fxd')
      call wrtsrf(jco214fxu(iogrp),    SRF_CO214FXU(iogrp), rnacc*12._rp*c14fac/dtbgc,0._rp,cmpflg,'co214fxu')
    endif
    if (use_CFC) then
      call wrtsrf(jcfc11fx(iogrp),     SRF_CFC11(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'cfc11flux')
      call wrtsrf(jcfc12fx(iogrp),     SRF_CFC12(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'cfc12flux')
      call wrtsrf(jsf6fx(iogrp),       SRF_SF6(iogrp),      rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'sf6flux')
    endif
    if (use_natDIC) then
      call wrtsrf(jsrfnatdic(iogrp),   SRF_NATDIC(iogrp),   rnacc*1.e3_rp,     0._rp,cmpflg,'srfnatdissic')
    ...
    if (use_BROMO) then
      ...
      call wrtsrf(jsrfbromo(iogrp),    SRF_BROMO(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'srfbromo')
      call wrtsrf(jbromo_prod(iogrp),  INT_BROMOPRO(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'intbromoprod')
      call wrtsrf(jbromo_uv(iogrp),    INT_BROMOUV(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'intbromouv')
      call wrtsrf(jatmbromo(iogrp),    SRF_ATMBROMO(iogrp), rnacc,              0._rp,cmpflg,'atmbromo')
    endif
    call wrtsrf(jatmco2(iogrp),      SRF_ATMCO2(iogrp),   rnacc,            0._rp,cmpflg,'atmco2')
    if (use_BOXATM) then
      call wrtsrf(jatmo2(iogrp),       SRF_ATMO2(iogrp),    rnacc,          0._rp,cmpflg,'atmo2')
      call wrtsrf(jatmn2(iogrp),       SRF_ATMN2(iogrp),    rnacc,          0._rp,cmpflg,'atmn2')
    endif
    if (use_cisonew) then
      call wrtsrf(jatmc13(iogrp),      SRF_ATMC13(iogrp),   rnacc,          0._rp,cmpflg,'atmc13')
      call wrtsrf(jatmc14(iogrp),      SRF_ATMC14(iogrp),   rnacc,          0._rp,cmpflg,'atmc14')
    endif
    if (use_extNcycle) then
      call wrtsrf(jsrfanh4(iogrp),     SRF_ANH4(iogrp),     rnacc*1.e3_rp,      0._rp,cmpflg,'srfnh4')
      call wrtsrf(jsrfpnh3(iogrp),     SRF_PNH3(iogrp),     rnacc,              0._rp,cmpflg,'pnh3')
      call wrtsrf(jsrfano2(iogrp),     SRF_ANO2(iogrp),     rnacc*1.e3_rp,      0._rp,cmpflg,'srfno2')
      call wrtsrf(janh3fx(iogrp),      SRF_ANH3FX(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'nh3flux')
      call wrtsrf(jatmnh3(iogrp),      SRF_ATMNH3(iogrp),   rnacc,              0._rp,cmpflg,'atmnh3')
      call wrtsrf(jatmn2o(iogrp),      SRF_ATMN2O(iogrp),   rnacc,              0._rp,cmpflg,'atmn2o')
      call wrtsrf(jndepnhxfx(iogrp),   FLX_NDEPNHX(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'ndepnhx')
    endif
    if (use_DOMclasses) then
      call wrtsrf(jintexudl(iogrp),    INT_EXUDL(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'exudlint')
      call wrtsrf(jintexudsl(iogrp),   INT_EXUDSL(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'exudslint')
      call wrtsrf(jintexcrl(iogrp),    INT_EXCRL(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'excrlint')
      call wrtsrf(jintexcrsl(iogrp),   INT_EXCRSL(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'excrslint')
      call wrtsrf(jintdocl_rem(iogrp), INT_DOCL_REM(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'docl_remint')
      call wrtsrf(jintdocsl_rem(iogrp),INT_DOCSL_REM(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'docsl_remint')
      call wrtsrf(jintdocsr_rem(iogrp),INT_DOCSR_REM(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'docsr_remint')
      call wrtsrf(jintdocr_rem(iogrp), INT_DOCR_REM(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'docr_remint')
    endif

    ! --- Store 3d layer fields
    call wrtlyr(jdp(iogrp),          LYR_DP(iogrp),       rnacc,              0._rp,cmpflg,'pddpo')
    call wrtlyr(jdic(iogrp),         LYR_DIC(iogrp),      1.e3_rp,            0._rp,cmpflg,'dissic')
    call wrtlyr(jalkali(iogrp),      LYR_ALKALI(iogrp),   1.e3_rp,            0._rp,cmpflg,'talk')
    call wrtlyr(jphosph(iogrp),      LYR_PHOSPH(iogrp),   1.e3_rp,            0._rp,cmpflg,'po4')
    call wrtlyr(joxygen(iogrp),      LYR_OXYGEN(iogrp),   1.e3_rp,            0._rp,cmpflg,'o2')
    call wrtlyr(jano3(iogrp),        LYR_ANO3(iogrp),     1.e3_rp,            0._rp,cmpflg,'no3')
    call wrtlyr(jsilica(iogrp),      LYR_SILICA(iogrp),   1.e3_rp,            0._rp,cmpflg,'si')
    call wrtlyr(jdoc(iogrp),         LYR_DOC(iogrp),      1.e3_rp,            0._rp,cmpflg,'dissoc')
    call wrtlyr(jphyto(iogrp),       LYR_PHYTO(iogrp),    1.e3_rp,            0._rp,cmpflg,'phyc')
    call wrtlyr(jgrazer(iogrp),      LYR_GRAZER(iogrp),   1.e3_rp,            0._rp,cmpflg,'zooc')
    call wrtlyr(jpoc(iogrp),         LYR_POC(iogrp),      1.e3_rp,            0._rp,cmpflg,'detoc')
    call wrtlyr(jcalc(iogrp),        LYR_CALC(iogrp),     1.e3_rp,            0._rp,cmpflg,'calc')
    call wrtlyr(jopal(iogrp),        LYR_OPAL(iogrp),     1.e3_rp,            0._rp,cmpflg,'opal')
    ...
    call wrtlyr(jo2sat(iogrp),       LYR_O2SAT(iogrp),    1.e3_rp,            0._rp,cmpflg,'satoxy')
    call wrtlyr(jdicsat(iogrp),      LYR_DICSAT(iogrp),   1.e3_rp,            0._rp,cmpflg,'sat_dic')
    if (use_pref_tracers) then
      call wrtlyr(jprefo2(iogrp),      LYR_PREFO2(iogrp),   1.e3_rp,            0._rp,cmpflg,'p_o2')
      call wrtlyr(jprefpo4(iogrp),     LYR_PREFPO4(iogrp),  1.e3_rp,            0._rp,cmpflg,'p_po4')
      call wrtlyr(jprefsilica(iogrp),  LYR_PREFSILICA(iogrp), 1.e3_rp,          0._rp,cmpflg,'p_silica')
      call wrtlyr(jprefalk(iogrp),     LYR_PREFALK(iogrp),  1.e3_rp,            0._rp,cmpflg,'p_talk')
      call wrtlyr(jprefdic(iogrp),     LYR_PREFDIC(iogrp),  1.e3_rp,            0._rp,cmpflg,'p_dic')
    endif
    if (use_shelfsea_res_time) then
      call wrtlyr(jshelfage(iogrp),     LYR_SHELFAGE(iogrp),  rnacc,            0._rp,cmpflg,'shelfage')
    endif
    if (use_river2omip) then
      call wrtlyr(jtdoc_lc(iogrp),     LYR_TDOC_LC(iogrp),  1.e3_rp,            0._rp,cmpflg,'tdoc_lc')
      call wrtlyr(jtdoc_hc(iogrp),     LYR_TDOC_HC(iogrp),  1.e3_rp,            0._rp,cmpflg,'tdoc_hc')
    endif
    if (use_cisonew) then
      call wrtlyr(jdic13(iogrp),       LYR_DIC13(iogrp),    1.e3_rp,            0._rp,cmpflg,'dissic13')
      call wrtlyr(jdic14(iogrp),       LYR_DIC14(iogrp),    1.e3_rp*c14fac,     0._rp,cmpflg,'dissic14')
      call wrtlyr(jd13c(iogrp),        LYR_D13C(iogrp),     1._rp,              0._rp,cmpflg,'delta13c')
      call wrtlyr(jd14c(iogrp),        LYR_D14C(iogrp),     1._rp,              0._rp,cmpflg,'delta14c')
      call wrtlyr(jbigd14c(iogrp),     LYR_BIGD14C(iogrp),  1._rp,              0._rp,cmpflg,'bigdelta14c')
      call wrtlyr(jpoc13(iogrp),       LYR_POC13(iogrp),    1.e3_rp,            0._rp,cmpflg,'detoc13')
      call wrtlyr(jdoc13(iogrp),       LYR_DOC13(iogrp),    1.e3_rp,            0._rp,cmpflg,'dissoc13')
      call wrtlyr(jcalc13(iogrp),      LYR_CALC13(iogrp),   1.e3_rp,            0._rp,cmpflg,'calc13')
      call wrtlyr(jphyto13(iogrp),     LYR_PHYTO13(iogrp),  1.e3_rp,            0._rp,cmpflg,'phyc13')
      call wrtlyr(jgrazer13(iogrp),    LYR_GRAZER13(iogrp), 1.e3_rp,            0._rp,cmpflg,'zooc13')
      if (use_river2omip) then
        call wrtlyr(jtdoc_lc13(iogrp),   LYR_TDOC_LC13(iogrp), 1.e3_rp,         0._rp,cmpflg,'tdoc_lc13')
        call wrtlyr(jtdoc_hc13(iogrp),   LYR_TDOC_HC13(iogrp), 1.e3_rp,         0._rp,cmpflg,'tdoc_hc13')
      endif
    endif
    if (use_AGG) then
      call wrtlyr(jnos(iogrp),         LYR_NOS(iogrp),      1._rp,              0._rp,cmpflg,'nos')
      call wrtlyr(jwphy(iogrp),        LYR_WPHY(iogrp),     1._rp,              0._rp,cmpflg,'wphy')
      call wrtlyr(jwnos(iogrp),        LYR_WNOS(iogrp),     1._rp,              0._rp,cmpflg,'wnos')
      call wrtlyr(jeps(iogrp),         LYR_EPS(iogrp),      1._rp,              0._rp,cmpflg,'eps')
      call wrtlyr(jasize(iogrp),       LYR_ASIZE(iogrp),    1._rp,              0._rp,cmpflg,'asize')
    endif
    if (use_CFC) then
      call wrtlyr(jcfc11(iogrp),       LYR_CFC11(iogrp),    1.e3_rp,            0._rp,cmpflg,'cfc11')
      call wrtlyr(jcfc12(iogrp),       LYR_CFC12(iogrp),    1.e3_rp,            0._rp,cmpflg,'cfc12')
      call wrtlyr(jsf6(iogrp),         LYR_SF6(iogrp),      1.e3_rp,            0._rp,cmpflg,'sf6')
    endif
    if (use_natDIC) then
      call wrtlyr(jnatco3(iogrp),      LYR_NATCO3(iogrp),   1.e3_rp,            0._rp,cmpflg,'natco3')
    ...
    if (use_BROMO) then
      call wrtlyr(jbromo(iogrp),       LYR_BROMO(iogrp),    1.e3_rp,            0._rp,cmpflg,'bromo')
    endif
    if (use_extNcycle) then
      call wrtlyr(janh4(iogrp),        LYR_ANH4(iogrp),     1.e3_rp,            0._rp,cmpflg,'nh4')
      call wrtlyr(jano2(iogrp),        LYR_ANO2(iogrp),     1.e3_rp,            0._rp,cmpflg,'no2')
      call wrtlyr(jnitr_NH4(iogrp),    LYR_nitr_NH4(iogrp), 1.e3_rp/dtbgc,      0._rp,cmpflg,'nh4nitr')
      call wrtlyr(jnitr_NO2(iogrp),    LYR_nitr_NO2(iogrp), 1.e3_rp/dtbgc,      0._rp,cmpflg,'no2nitr')
      call wrtlyr(jnitr_N2O_prod(iogrp),LYR_nitr_N2O_prod(iogrp),1.e3_rp/dtbgc, 0._rp,cmpflg,'nitr_n2o')
      call wrtlyr(jnitr_NH4_OM(iogrp), LYR_nitr_NH4_OM(iogrp),1.e3_rp/dtbgc,    0._rp,cmpflg,'nh4nitr_om')
      call wrtlyr(jnitr_NO2_OM(iogrp), LYR_nitr_NO2_OM(iogrp),1.e3_rp/dtbgc,    0._rp,cmpflg,'no2nitr_om')
      call wrtlyr(jdenit_NO3(iogrp),   LYR_denit_NO3(iogrp),1.e3_rp/dtbgc,      0._rp,cmpflg,'no3denit')
      call wrtlyr(jdenit_NO2(iogrp),   LYR_denit_NO2(iogrp),1.e3_rp/dtbgc,      0._rp,cmpflg,'no2denit')
      call wrtlyr(jdenit_N2O(iogrp),   LYR_denit_N2O(iogrp),1.e3_rp/dtbgc,      0._rp,cmpflg,'n2odenit')
      call wrtlyr(jDNRA_NO2(iogrp),    LYR_DNRA_NO2(iogrp), 1.e3_rp/dtbgc,      0._rp,cmpflg,'no2dnra')
      call wrtlyr(janmx_N2_prod(iogrp),LYR_anmx_N2_prod(iogrp),1.e3_rp/dtbgc,   0._rp,cmpflg,'anmx_n2')
      call wrtlyr(janmx_OM_prod(iogrp),LYR_anmx_OM_prod(iogrp),1.e3_rp/dtbgc,   0._rp,cmpflg,'anmx_om')
      call wrtlyr(jphosy_NH4(iogrp),   LYR_phosy_NH4(iogrp),1.e3_rp/dtbgc,      0._rp,cmpflg,'phosy_nh4')
      call wrtlyr(jphosy_NO3(iogrp),   LYR_phosy_NO3(iogrp),1.e3_rp/dtbgc,      0._rp,cmpflg,'phosy_no3')
      call wrtlyr(jremin_aerob(iogrp), LYR_remin_aerob(iogrp),1.e3_rp/dtbgc,    0._rp,cmpflg,'remina')
      call wrtlyr(jremin_sulf(iogrp),  LYR_remin_sulf(iogrp),1.e3_rp/dtbgc,     0._rp,cmpflg,'remins')
    endif
    if (use_M4AGO) then
      !      M4AGO
      call wrtlyr(jagg_ws(iogrp),      LYR_agg_ws(iogrp),   1._rp,             0._rp,cmpflg,'agg_ws')
      call wrtlyr(jdynvis(iogrp),      LYR_dynvis(iogrp),   1._rp,             0._rp,cmpflg,'dynvis')
      call wrtlyr(jagg_stick(iogrp),   LYR_agg_stick(iogrp),1._rp,             0._rp,cmpflg,'agg_stick')
      call wrtlyr(jagg_stickf(iogrp),  LYR_agg_stickf(iogrp),1._rp,            0._rp,cmpflg,'agg_stickf')
      call wrtlyr(jagg_dmax(iogrp),    LYR_agg_dmax(iogrp), 1._rp,             0._rp,cmpflg,'agg_dmax')
      call wrtlyr(jagg_avdp(iogrp),    LYR_agg_avdp(iogrp), 1._rp,             0._rp,cmpflg,'agg_avdp')
      call wrtlyr(jagg_avrhop(iogrp),  LYR_agg_avrhop(iogrp),1._rp,            0._rp,cmpflg,'agg_avrhop')
      call wrtlyr(jagg_avdC(iogrp),    LYR_agg_avdC(iogrp), 1._rp,             0._rp,cmpflg,'agg_avdC')
      call wrtlyr(jagg_df(iogrp),      LYR_agg_df(iogrp),   1._rp,             0._rp,cmpflg,'agg_df')
      call wrtlyr(jagg_b(iogrp),       LYR_agg_b(iogrp),    1._rp,             0._rp,cmpflg,'agg_b')
      call wrtlyr(jagg_Vrhof(iogrp),   LYR_agg_Vrhof(iogrp),1._rp,             0._rp,cmpflg,'agg_Vrhof')
      call wrtlyr(jagg_Vpor(iogrp),    LYR_agg_Vpor(iogrp), 1._rp,             0._rp,cmpflg,'agg_Vpor')
    endif
    if (use_DOMclasses) then
      call wrtlyr(jdocsl(iogrp),       LYR_DOCSL(iogrp),    1.e3_rp,            0._rp,cmpflg,'dissocsl')
      call wrtlyr(jdocsr(iogrp),       LYR_DOCSR(iogrp),    1.e3_rp,            0._rp,cmpflg,'dissocsr')
      call wrtlyr(jdocr(iogrp),        LYR_DOCR(iogrp),     1.e3_rp,            0._rp,cmpflg,'dissocr')
    endif
    if (use_DOMclasses .and. use_pref_tracers) then
      call wrtlyr(jprefdoc(iogrp),     LYR_PREFDOC(iogrp),  1.e3_rp,            0._rp,cmpflg,'p_doc')
      call wrtlyr(jprefdocsl(iogrp),   LYR_PREFDOCSL(iogrp),1.e3_rp,            0._rp,cmpflg,'p_docsl')
      call wrtlyr(jprefdocsr(iogrp),   LYR_PREFDOCSR(iogrp),1.e3_rp,            0._rp,cmpflg,'p_docsr')
      call wrtlyr(jprefdocr(iogrp),    LYR_PREFDOCR(iogrp), 1.e3_rp,            0._rp,cmpflg,'p_docr')
    endif

    ! --- Store 3d level fields
    call wrtlvl(jlvldic(iogrp),      LVL_DIC(iogrp),      rnacc*1.e3_rp,      0._rp,cmpflg,'dissiclvl')
    call wrtlvl(jlvlalkali(iogrp),   LVL_ALKALI(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'talklvl')
    call wrtlvl(jlvlphosph(iogrp),   LVL_PHOSPH(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'po4lvl')
    call wrtlvl(jlvloxygen(iogrp),   LVL_OXYGEN(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'o2lvl')
    call wrtlvl(jlvlano3(iogrp),     LVL_ANO3(iogrp),     rnacc*1.e3_rp,      0._rp,cmpflg,'no3lvl')
    call wrtlvl(jlvlsilica(iogrp),   LVL_SILICA(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'silvl')
    call wrtlvl(jlvldoc(iogrp),      LVL_DOC(iogrp),      rnacc*1.e3_rp,      0._rp,cmpflg,'dissoclvl')
    call wrtlvl(jlvlphyto(iogrp),    LVL_PHYTO(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'phyclvl')
    call wrtlvl(jlvlgrazer(iogrp),   LVL_GRAZER(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'zooclvl')
    call wrtlvl(jlvlpoc(iogrp),      LVL_POC(iogrp),      rnacc*1.e3_rp,      0._rp,cmpflg,'detoclvl')
    call wrtlvl(jlvlcalc(iogrp),     LVL_CALC(iogrp),     rnacc*1.e3_rp,      0._rp,cmpflg,'calclvl')
    call wrtlvl(jlvlopal(iogrp),     LVL_OPAL(iogrp),     rnacc*1.e3_rp,      0._rp,cmpflg,'opallvl')
    ...
    call wrtlvl(jlvlo2sat(iogrp),    LVL_O2SAT(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'satoxylvl')
    call wrtlvl(jlvldicsat(iogrp),   LVL_DICSAT(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'sat_diclvl')
    call wrtlvl(jlvlnutlim_fe(iogrp),LVL_NUTLIM_FE(iogrp),rnacc    ,          0._rp,cmpflg,'nlim_felvl')
    call wrtlvl(jlvlnutlim_n(iogrp), LVL_NUTLIM_N(iogrp), rnacc    ,          0._rp,cmpflg,'nlim_nlvl')
    call wrtlvl(jlvlnutlim_phosph(iogrp),LVL_NUTLIM_PHOSPH(iogrp),rnacc,      0._rp,cmpflg,'nlim_po4lvl')
    if (use_pref_tracers) then
      call wrtlvl(jlvlprefo2(iogrp),   LVL_PREFO2(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'p_o2lvl')
      call wrtlvl(jlvlprefpo4(iogrp),  LVL_PREFPO4(iogrp),  rnacc*1.e3_rp,      0._rp,cmpflg,'p_po4lvl')
      call wrtlvl(jlvlprefsilica(iogrp),LVL_PREFSILICA(iogrp), rnacc*1.e3_rp,   0._rp,cmpflg,'p_silicalvl')
      call wrtlvl(jlvlprefalk(iogrp),  LVL_PREFALK(iogrp),  rnacc*1.e3_rp,      0._rp,cmpflg,'p_talklvl')
      call wrtlvl(jlvlprefdic(iogrp),  LVL_PREFDIC(iogrp),  rnacc*1.e3_rp,      0._rp,cmpflg,'p_diclvl')
    endif
    if (use_shelfsea_res_time) then
      call wrtlvl(jlvlshelfage(iogrp),  LVL_SHELFAGE(iogrp),  rnacc,            0._rp,cmpflg,'shelfagelvl')
    endif
    if (use_river2omip) then
      call wrtlvl(jlvltdoc_lc(iogrp),  LVL_TDOC_LC(iogrp),  rnacc*1.e3_rp,      0._rp,cmpflg,'tdoc_lclvl')
      call wrtlvl(jlvltdoc_hc(iogrp),  LVL_TDOC_HC(iogrp),  rnacc*1.e3_rp,      0._rp,cmpflg,'tdoc_hclvl')
    endif
    if (use_cisonew) then
      call wrtlvl(jlvldic13(iogrp),    LVL_DIC13(iogrp),    rnacc*1.e3_rp,       0._rp,cmpflg,'dissic13lvl')
      call wrtlvl(jlvldic14(iogrp),    LVL_DIC14(iogrp),    rnacc*1.e3_rp*c14fac,0._rp,cmpflg,'dissic14lvl')
      call wrtlvl(jlvld13c(iogrp),     LVL_D13C(iogrp),     rnacc,               0._rp,cmpflg,'delta13clvl')
      call wrtlvl(jlvld14c(iogrp),     LVL_D14C(iogrp),     rnacc,               0._rp,cmpflg,'delta14clvl')
      call wrtlvl(jlvlbigd14c(iogrp),  LVL_BIGD14C(iogrp),  rnacc,               0._rp,cmpflg,'bigdelta14clvl')
      call wrtlvl(jlvlpoc13(iogrp),    LVL_POC13(iogrp),    rnacc*1.e3_rp,       0._rp,cmpflg,'detoc13lvl')
      call wrtlvl(jlvldoc13(iogrp),    LVL_DOC13(iogrp),    rnacc*1.e3_rp,       0._rp,cmpflg,'dissoc13lvl')
      call wrtlvl(jlvlcalc13(iogrp),   LVL_CALC13(iogrp),   rnacc*1.e3_rp,       0._rp,cmpflg,'calc13lvl')
      call wrtlvl(jlvlphyto13(iogrp),  LVL_PHYTO13(iogrp),  rnacc*1.e3_rp,       0._rp,cmpflg,'phyc13lvl')
      call wrtlvl(jlvlgrazer13(iogrp), LVL_GRAZER13(iogrp), rnacc*1.e3_rp,       0._rp,cmpflg,'zooc13lvl')
      if (use_river2omip) then
        call wrtlvl(jlvltdoc_lc13(iogrp), LVL_TDOC_LC13(iogrp), rnacc*1.e3_rp,   0._rp,cmpflg,'tdoc_lc13lvl')
        call wrtlvl(jlvltdoc_hc13(iogrp), LVL_TDOC_HC13(iogrp), rnacc*1.e3_rp,   0._rp,cmpflg,'tdoc_hc13lvl')
      endif
    endif
    if (use_AGG) then
      call wrtlvl(jlvlnos(iogrp),      LVL_NOS(iogrp),      rnacc,          0._rp,cmpflg,'noslvl')
      call wrtlvl(jlvlwphy(iogrp),     LVL_WPHY(iogrp),     rnacc,          0._rp,cmpflg,'wphylvl')
      call wrtlvl(jlvlwnos(iogrp),     LVL_WNOS(iogrp),     rnacc,          0._rp,cmpflg,'wnoslvl')
      call wrtlvl(jlvleps(iogrp),      LVL_EPS(iogrp),      rnacc,          0._rp,cmpflg,'epslvl')
      call wrtlvl(jlvlasize(iogrp),    LVL_ASIZE(iogrp),    rnacc,          0._rp,cmpflg,'asizelvl')
    endif
    if (use_CFC) then
      call wrtlvl(jlvlcfc11(iogrp),    LVL_CFC11(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'cfc11lvl')
      call wrtlvl(jlvlcfc12(iogrp),    LVL_CFC12(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'cfc12lvl')
      call wrtlvl(jlvlsf6(iogrp),      LVL_SF6(iogrp),      rnacc*1.e3_rp,      0._rp,cmpflg,'sf6lvl')
    endif
    if (use_natDIC) then
      call wrtlvl(jlvlnatco3(iogrp),   LVL_NATCO3(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'natco3lvl')
    ...
    if (use_BROMO) then
      call wrtlvl(jlvlbromo(iogrp),    LVL_BROMO(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'bromolvl')
    endif
    if (use_extNcycle) then
      call wrtlvl(jlvlanh4(iogrp),          LVL_ANH4(iogrp),         rnacc*1.e3_rp,      0._rp,cmpflg,'nh4lvl')
      call wrtlvl(jlvlano2(iogrp),          LVL_ANO2(iogrp),         rnacc*1.e3_rp,      0._rp,cmpflg,'no2lvl')
      call wrtlvl(jlvl_nitr_NH4(iogrp),     LVL_nitr_NH4(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'nh4nitrlvl')
      call wrtlvl(jlvl_nitr_NO2(iogrp),     LVL_nitr_NO2(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2nitrlvl')
      call wrtlvl(jlvl_nitr_N2O_prod(iogrp),LVL_nitr_N2O_prod(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'nitr_n2olvl')
      call wrtlvl(jlvl_nitr_NH4_OM(iogrp),  LVL_nitr_NH4_OM(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'nh4nitr_omlvl')
      call wrtlvl(jlvl_nitr_NO2_OM(iogrp),  LVL_nitr_NO2_OM(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2nitr_omlvl')
      call wrtlvl(jlvl_denit_NO3(iogrp),    LVL_denit_NO3(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no3denitlvl')
      call wrtlvl(jlvl_denit_NO2(iogrp),    LVL_denit_NO2(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2denitlvl')
      call wrtlvl(jlvl_denit_N2O(iogrp),    LVL_denit_N2O(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'n2odenitlvl')
      call wrtlvl(jlvl_DNRA_NO2(iogrp),     LVL_DNRA_NO2(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2dnralvl')
      call wrtlvl(jlvl_anmx_N2_prod(iogrp), LVL_anmx_N2_prod(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'anmx_n2lvl')
      call wrtlvl(jlvl_anmx_OM_prod(iogrp), LVL_anmx_OM_prod(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'anmx_omlvl')
      call wrtlvl(jlvl_phosy_NH4(iogrp),    LVL_phosy_NH4(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'phosy_nh4lvl')
      call wrtlvl(jlvl_phosy_NO3(iogrp),    LVL_phosy_NO3(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'phosy_no3lvl')
      call wrtlvl(jlvl_remin_aerob(iogrp),  LVL_remin_aerob(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'reminalvl')
      call wrtlvl(jlvl_remin_sulf(iogrp),   LVL_remin_sulf(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'reminslvl')
    endif
    if (use_M4AGO) then
      !      M4AGO
      call wrtlvl(jlvl_agg_ws(iogrp),       LVL_agg_ws(iogrp),       rnacc,          0._rp,cmpflg,'agg_wslvl')
      call wrtlvl(jlvl_dynvis(iogrp),       LVL_dynvis(iogrp),       rnacc,          0._rp,cmpflg,'dynvislvl')
      call wrtlvl(jlvl_agg_stick(iogrp),    LVL_agg_stick(iogrp),    rnacc,          0._rp,cmpflg,'agg_sticklvl')
      call wrtlvl(jlvl_agg_stickf(iogrp),   LVL_agg_stickf(iogrp),   rnacc,          0._rp,cmpflg,'agg_stickflvl')
      call wrtlvl(jlvl_agg_dmax(iogrp),     LVL_agg_dmax(iogrp),     rnacc,          0._rp,cmpflg,'agg_dmaxlvl')
      call wrtlvl(jlvl_agg_avdp(iogrp),     LVL_agg_avdp(iogrp),     rnacc,          0._rp,cmpflg,'agg_avdplvl')
      call wrtlvl(jlvl_agg_avrhop(iogrp),   LVL_agg_avrhop(iogrp),   rnacc,          0._rp,cmpflg,'agg_avrhoplvl')
      call wrtlvl(jlvl_agg_avdC(iogrp),     LVL_agg_avdC(iogrp),     rnacc,          0._rp,cmpflg,'agg_avdClvl')
      call wrtlvl(jlvl_agg_df(iogrp),       LVL_agg_df(iogrp),       rnacc,          0._rp,cmpflg,'agg_dflvl')
      call wrtlvl(jlvl_agg_b(iogrp),        LVL_agg_b(iogrp),        rnacc,          0._rp,cmpflg,'agg_blvl')
      call wrtlvl(jlvl_agg_Vrhof(iogrp),    LVL_agg_Vrhof(iogrp),    rnacc,          0._rp,cmpflg,'agg_Vrhoflvl')
      call wrtlvl(jlvl_agg_Vpor(iogrp),     LVL_agg_Vpor(iogrp),     rnacc,          0._rp,cmpflg,'agg_Vporlvl')
    endif
    if (use_DOMclasses) then
      call wrtlvl(jlvldocsl(iogrp),     LVL_DOCSL(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'dissocsllvl')
      call wrtlvl(jlvldocsr(iogrp),     LVL_DOCSR(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'dissocsrlvl')
      call wrtlvl(jlvldocr(iogrp),      LVL_DOCR(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'dissocrlvl')
    endif
    if (use_DOMclasses .and. use_pref_tracers) then
      call wrtlvl(jlvlprefdoc(iogrp),   LVL_PREFDOC(iogrp),   rnacc*1.e3_rp,    0._rp,cmpflg,'p_doclvl')
      call wrtlvl(jlvlprefdocsl(iogrp), LVL_PREFDOCSL(iogrp), rnacc*1.e3_rp,    0._rp,cmpflg,'p_docsllvl')
      call wrtlvl(jlvlprefdocsr(iogrp), LVL_PREFDOCSR(iogrp), rnacc*1.e3_rp,    0._rp,cmpflg,'p_docsrlvl')
      call wrtlvl(jlvlprefdocr(iogrp),  LVL_PREFDOCR(iogrp),  rnacc*1.e3_rp,    0._rp,cmpflg,'p_docrlvl')
    endif

    ! --- Store sediment fields
    if (.not. use_sedbypass) then
      call wrtsdm(jpowaic(iogrp),      SDM_POWAIC(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'powdic')
      call wrtsdm(jpowaal(iogrp),      SDM_POWAAL(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'powalk')
      call wrtsdm(jpowaph(iogrp),      SDM_POWAPH(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'powpho')
      call wrtsdm(jpowaox(iogrp),      SDM_POWAOX(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'powox')
      call wrtsdm(jpown2(iogrp),       SDM_POWN2(iogrp),    rnacc*1.e3_rp,      0._rp,cmpflg,'pown2')
      call wrtsdm(jpowno3(iogrp),      SDM_POWNO3(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'powno3')
      call wrtsdm(jpowasi(iogrp),      SDM_POWASI(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'powsi')
      call wrtsdm(jssso12(iogrp),      SDM_SSSO12(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'ssso12')
      call wrtsdm(jssssil(iogrp),      SDM_SSSSIL(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'ssssil')
      call wrtsdm(jsssc12(iogrp),      SDM_SSSC12(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'sssc12')
      call wrtsdm(jssster(iogrp),      SDM_SSSTER(iogrp),   rnacc,              0._rp,cmpflg,'ssster')

      ! --- Store sediment burial fields
      call wrtbur(jburssso12(iogrp),   BUR_SSSO12(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'buro12')
      call wrtbur(jbursssc12(iogrp),   BUR_SSSC12(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'burc12')
      call wrtbur(jburssssil(iogrp),   BUR_SSSSIL(iogrp),   rnacc*1.e3_rp,      0._rp,cmpflg,'bursil')
      call wrtbur(jburssster(iogrp),   BUR_SSSTER(iogrp),   rnacc,              0._rp,cmpflg,'burter')
      if (use_extNcycle) then
        call wrtsdm(jpownh4(iogrp),           SDM_POWNH4(iogrp),       rnacc*1.e3_rp,      0._rp,cmpflg,'pownh4')
        call wrtsdm(jpown2o(iogrp),           SDM_POWN2O(iogrp),       rnacc*1.e3_rp,      0._rp,cmpflg,'pown2o')
        call wrtsdm(jpowno2(iogrp),           SDM_POWNO2(iogrp),       rnacc*1.e3_rp,      0._rp,cmpflg,'powno2')
        call wrtsdm(jsdm_nitr_NH4(iogrp),     sdm_nitr_NH4(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'nh4nitrsdm')
        call wrtsdm(jsdm_nitr_NO2(iogrp),     sdm_nitr_NO2(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2nitrsdm')
        call wrtsdm(jsdm_nitr_N2O_prod(iogrp),sdm_nitr_N2O_prod(iogrp),rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'nitr_n2osdm')
        call wrtsdm(jsdm_nitr_NH4_OM(iogrp),  sdm_nitr_NH4_OM(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'nh4nitr_omsdm')
        call wrtsdm(jsdm_nitr_NO2_OM(iogrp),  sdm_nitr_NO2_OM(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2nitr_omsdm')
        call wrtsdm(jsdm_denit_NO3(iogrp),    sdm_denit_NO3(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no3denitsdm')
        call wrtsdm(jsdm_denit_NO2(iogrp),    sdm_denit_NO2(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2denitsdm')
        call wrtsdm(jsdm_denit_N2O(iogrp),    sdm_denit_N2O(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'n2odenitsdm')
        call wrtsdm(jsdm_DNRA_NO2(iogrp),     sdm_DNRA_NO2(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'no2dnrasdm')
        call wrtsdm(jsdm_anmx_N2_prod(iogrp), sdm_anmx_N2_prod(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'anmx_n2sdm')
        call wrtsdm(jsdm_anmx_OM_prod(iogrp), sdm_anmx_OM_prod(iogrp), rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'anmx_omsdm')
        call wrtsdm(jsdm_remin_aerob(iogrp),  sdm_remin_aerob(iogrp),  rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'reminasdm')
        call wrtsdm(jsdm_remin_sulf(iogrp),   sdm_remin_sulf(iogrp),   rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'reminssdm')
      else
        call wrtsdm(jsdm_rem_aerob(iogrp),    sdm_rem_aerob(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'remasdm')
        call wrtsdm(jsdm_rem_denit(iogrp),    sdm_rem_denit(iogrp),    rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'remdsdm')
        call wrtsdm(jsdm_rem_sulf(iogrp),     sdm_rem_sulf(iogrp),     rnacc*1.e3_rp/dtbgc,0._rp,cmpflg,'remssdm')
      endif
      if (use_sediment_quality) then
        call wrtsdm(jsdm_qual_a(iogrp),     sdm_qual_a(iogrp),     rnacc,      0._rp,cmpflg,'quala_sdm')
        call wrtsdm(jsdm_qual_k(iogrp),     sdm_qual_k(iogrp),     rnacc/dtbgc,0._rp,cmpflg,'qualk_sdm')
        call wrtsdm(jsdm_qual_app(iogrp),   sdm_qual_app(iogrp),   rnacc/dtbgc,0._rp,cmpflg,'qualapp_sdm')
        call wrtsdm(jsdm_ssso12_age(iogrp), sdm_ssso12_age(iogrp), rnacc,      0._rp,cmpflg,'ssso12_age_sdm')
      endif
    endif
    ...
    ! --- Initialise fields
    call inisrf(jkwco2(iogrp),0._rp)
    call inisrf(jkwco2sol(iogrp),0._rp)
    call inisrf(jco2sol(iogrp),0._rp)
    call inisrf(jfco2(iogrp),0._rp)
    call inisrf(jpco2(iogrp),0._rp)
    call inisrf(jxco2(iogrp),0._rp)
    call inisrf(jpco2_gex(iogrp),0._rp)
    call inisrf(jdmsflux(iogrp),0._rp)
    call inisrf(jco2fxd(iogrp),0._rp)
    call inisrf(jco2fxu(iogrp),0._rp)
    call inisrf(joxflux(iogrp),0._rp)
    call inisrf(jniflux(iogrp),0._rp)
    call inisrf(jn2ofx(iogrp),0._rp)
    call inisrf(jsrfpn2om(iogrp),0._rp)
    call inisrf(jdms(iogrp),0._rp)
    call inisrf(jdmsprod(iogrp),0._rp)
    call inisrf(jdms_bac(iogrp),0._rp)
    call inisrf(jdms_uv(iogrp),0._rp)
    call inisrf(jexport(iogrp),0._rp)
    call inisrf(jexposi(iogrp),0._rp)
    call inisrf(jexpoca(iogrp),0._rp)
    call inisrf(jsrfdic(iogrp),0._rp)
    call inisrf(jsrfalkali(iogrp),0._rp)
    call inisrf(jsrfphosph(iogrp),0._rp)
    call inisrf(jsrfoxygen(iogrp),0._rp)
    call inisrf(jsrfano3(iogrp),0._rp)
    call inisrf(jsrfsilica(iogrp),0._rp)
    ...
    call inisrf(jcarflx2000(iogrp),0._rp)
    call inisrf(jcarflx4000(iogrp),0._rp)
    call inisrf(jcarflx_bot(iogrp),0._rp)
    call inisrf(jbsiflx0100(iogrp),0._rp)
    call inisrf(jbsiflx0500(iogrp),0._rp)
    call inisrf(jbsiflx1000(iogrp),0._rp)
    call inisrf(jbsiflx2000(iogrp),0._rp)
    call inisrf(jbsiflx4000(iogrp),0._rp)
    call inisrf(jbsiflx_bot(iogrp),0._rp)
    call inisrf(jcalflx0100(iogrp),0._rp)
    call inisrf(jcalflx0500(iogrp),0._rp)
    call inisrf(jcalflx1000(iogrp),0._rp)
    call inisrf(jcalflx2000(iogrp),0._rp)
    call inisrf(jcalflx4000(iogrp),0._rp)
    call inisrf(jcalflx_bot(iogrp),0._rp)
    call inisrf(jdustflx0100(iogrp),0._rp)
    call inisrf(jdustflx0500(iogrp),0._rp)
    call inisrf(jdustflx1000(iogrp),0._rp)
    call inisrf(jdustflx2000(iogrp),0._rp)
    call inisrf(jdustflx4000(iogrp),0._rp)
    call inisrf(jdustflx_bot(iogrp),0._rp)
    call inisrf(jzeunutlim_fe(iogrp),0._rp)
    call inisrf(jzeunutlim_phosph(iogrp),0._rp)
    call inisrf(jzeunutlim_n(iogrp),0._rp)
    if (.not. use_sedbypass) then
      call inisrf(jsediffic(iogrp),0._rp)
      call inisrf(jsediffal(iogrp),0._rp)
      call inisrf(jsediffph(iogrp),0._rp)
      call inisrf(jsediffox(iogrp),0._rp)
      call inisrf(jsediffn2(iogrp),0._rp)
      call inisrf(jsediffno3(iogrp),0._rp)
      call inisrf(jsediffsi(iogrp),0._rp)
      call inisrf(jburflxsso12(iogrp),0._rp)
      call inisrf(jburflxsssc12(iogrp),0._rp)
      call inisrf(jburflxssssil(iogrp),0._rp)
      call inisrf(jburflxssster(iogrp),0._rp)
      if (use_sediment_quality) then
        call inisrf(jsed_mavg_prorca(iogrp),0._rp)
      endif
    endif
    if (use_cisonew) then
      call inisrf(jco213fxd(iogrp),0._rp)
      call inisrf(jco213fxu(iogrp),0._rp)
      call inisrf(jco214fxd(iogrp),0._rp)
      call inisrf(jco214fxu(iogrp),0._rp)
    endif
    if (use_CFC) then
      call inisrf(jcfc11fx(iogrp),0._rp)
      call inisrf(jcfc12fx(iogrp),0._rp)
      call inisrf(jsf6fx(iogrp),0._rp)
    endif
    if (use_natDIC) then
      call inisrf(jsrfnatdic(iogrp),0._rp)
      call inisrf(jsrfnatalk(iogrp),0._rp)
      call inisrf(jnatpco2(iogrp),0._rp)
      call inisrf(jnatco2fx(iogrp),0._rp)
      call inisrf(jsrfnatph(iogrp),0._rp)
    endif
    if (use_BROMO) then
      call inisrf(jsrfbromo(iogrp),0._rp)
      call inisrf(jbromofx(iogrp),0._rp)
      call inisrf(jbromo_prod(iogrp),0._rp)
      call inisrf(jbromo_uv(iogrp),0._rp)
      call inisrf(jatmbromo(iogrp),0._rp)
    endif
    if (use_DOMclasses) then
      call inisrf(jintexudl(iogrp),0._rp)
      call inisrf(jintexudsl(iogrp),0._rp)
      call inisrf(jintexcrl(iogrp),0._rp)
      call inisrf(jintexcrsl(iogrp),0._rp)
      call inisrf(jintdocl_rem(iogrp),0._rp)
      call inisrf(jintdocsl_rem(iogrp),0._rp)
      call inisrf(jintdocsr_rem(iogrp),0._rp)
      call inisrf(jintdocr_rem(iogrp),0._rp)
    endif

    call inisrf(jatmco2(iogrp),0._rp)
    if (use_BOXATM) then
      call inisrf(jatmo2(iogrp),0._rp)
      call inisrf(jatmn2(iogrp),0._rp)
    endif
    if (use_cisonew) then
      call inisrf(jatmc13(iogrp),0._rp)
      call inisrf(jatmc14(iogrp),0._rp)
    endif
    if (use_extNcycle) then
      call inisrf(jsrfanh4(iogrp),0._rp)
      call inisrf(jsrfpnh3(iogrp),0._rp)
      call inisrf(jsrfano2(iogrp),0._rp)
      call inisrf(janh3fx(iogrp),0._rp)
      call inisrf(jatmnh3(iogrp),0._rp)
      call inisrf(jatmn2o(iogrp),0._rp)
      call inisrf(jndepnhxfx(iogrp),0._rp)
      if (.not. use_sedbypass) then
        call inisrf(jsediffnh4(iogrp),0._rp)
        call inisrf(jsediffn2o(iogrp),0._rp)
        call inisrf(jsediffno2(iogrp),0._rp)
      endif
    endif
    call inilyr(jdp(iogrp),0._rp)
    call inilyr(jdic(iogrp),0._rp)
    call inilyr(jalkali(iogrp),0._rp)
    call inilyr(jphosy(iogrp),0._rp)
    call inilyr(jphosph(iogrp),0._rp)
    call inilyr(joxygen(iogrp),0._rp)
    call inilyr(jano3(iogrp),0._rp)
    call inilyr(jsilica(iogrp),0._rp)
    call inilyr(jdoc(iogrp),0._rp)
    call inilyr(jphyto(iogrp),0._rp)
    call inilyr(jgrazer(iogrp),0._rp)
    call inilyr(jpoc(iogrp),0._rp)
    call inilyr(jcalc(iogrp),0._rp)
    call inilyr(jopal(iogrp),0._rp)
    call inilyr(jiron(iogrp),0._rp)
    call inilyr(jco3(iogrp),0._rp)
    call inilyr(jph(iogrp),0._rp)
    call inilyr(jomegaa(iogrp),0._rp)
    call inilyr(jomegac(iogrp),0._rp)
    call inilyr(jn2o(iogrp),0._rp)
    call inilyr(jo2sat(iogrp),0._rp)
    call inilyr(jdicsat(iogrp),0._rp)
    if (use_pref_tracers) then
      call inilyr(jprefo2(iogrp),0._rp)
      call inilyr(jprefpo4(iogrp),0._rp)
      call inilyr(jprefsilica(iogrp),0._rp)
      call inilyr(jprefalk(iogrp),0._rp)
      call inilyr(jprefdic(iogrp),0._rp)
    endif
    if (use_shelfsea_res_time) then
      call inilyr(jshelfage(iogrp),0._rp)
    endif
    if (use_river2omip) then
      call inilyr(jtdoc_lc(iogrp),0._rp)
      call inilyr(jtdoc_hc(iogrp),0._rp)
    endif
    if (use_cisonew) then
      call inilyr(jdic13(iogrp),0._rp)
      call inilyr(jdic14(iogrp),0._rp)
      call inilyr(jd13c(iogrp),0._rp)
      call inilyr(jd14c(iogrp),0._rp)
      call inilyr(jbigd14c(iogrp),0._rp)
      call inilyr(jpoc13(iogrp),0._rp)
      call inilyr(jdoc13(iogrp),0._rp)
      call inilyr(jcalc13(iogrp),0._rp)
      call inilyr(jphyto13(iogrp),0._rp)
      call inilyr(jgrazer13(iogrp),0._rp)
      if (use_river2omip) then
        call inilyr(jtdoc_lc13(iogrp),0._rp)
        call inilyr(jtdoc_hc13(iogrp),0._rp)
      endif
    endif
    if (use_AGG) then
      call inilyr(jnos(iogrp),0._rp)
      call inilyr(jwphy(iogrp),0._rp)
      call inilyr(jwnos(iogrp),0._rp)
      call inilyr(jeps(iogrp),0._rp)
      call inilyr(jasize(iogrp),0._rp)
    endif
    if (use_CFC) then
      call inilyr(jcfc11(iogrp),0._rp)
      call inilyr(jcfc12(iogrp),0._rp)
      call inilyr(jsf6(iogrp),0._rp)
    endif
    if (use_natDIC) then
      call inilyr(jnatco3(iogrp),0._rp)
      call inilyr(jnatalkali(iogrp),0._rp)
      call inilyr(jnatdic(iogrp),0._rp)
      call inilyr(jnatcalc(iogrp),0._rp)
      call inilyr(jnatph(iogrp),0._rp)
      call inilyr(jnatomegaa(iogrp),0._rp)
      call inilyr(jnatomegac(iogrp),0._rp)
    endif
    if (use_BROMO) then
      call inilyr(jbromo(iogrp),0._rp)
    endif
    if (use_extNcycle) then
      call inilyr(janh4(iogrp),0._rp)
      call inilyr(jano2(iogrp),0._rp)
      call inilyr(jnitr_NH4(iogrp),0._rp)
      call inilyr(jnitr_NO2(iogrp),0._rp)
      call inilyr(jnitr_N2O_prod(iogrp),0._rp)
      call inilyr(jnitr_NH4_OM(iogrp),0._rp)
      call inilyr(jnitr_NO2_OM(iogrp),0._rp)
      call inilyr(jdenit_NO3(iogrp),0._rp)
      call inilyr(jdenit_NO2(iogrp),0._rp)
      call inilyr(jdenit_N2O(iogrp),0._rp)
      call inilyr(jDNRA_NO2(iogrp),0._rp)
      call inilyr(janmx_N2_prod(iogrp),0._rp)
      call inilyr(janmx_OM_prod(iogrp),0._rp)
      call inilyr(jphosy_NH4(iogrp),0._rp)
      call inilyr(jphosy_NO3(iogrp),0._rp)
      call inilyr(jremin_aerob(iogrp),0._rp)
      call inilyr(jremin_sulf(iogrp),0._rp)
    endif
    if (use_M4AGO) then
      !   M4AGO
      call inilyr(jagg_ws(iogrp),0._rp)
      call inilyr(jdynvis(iogrp),0._rp)
      call inilyr(jagg_stick(iogrp),0._rp)
      call inilyr(jagg_stickf(iogrp),0._rp)
      call inilyr(jagg_dmax(iogrp),0._rp)
      call inilyr(jagg_avdp(iogrp),0._rp)
      call inilyr(jagg_avrhop(iogrp),0._rp)
      call inilyr(jagg_avdC(iogrp),0._rp)
      call inilyr(jagg_df(iogrp),0._rp)
      call inilyr(jagg_b(iogrp),0._rp)
      call inilyr(jagg_Vrhof(iogrp),0._rp)
      call inilyr(jagg_Vpor(iogrp),0._rp)
    endif
    if (use_DOMclasses) then
      call inilyr(jdocsl(iogrp),0._rp)
      call inilyr(jdocsr(iogrp),0._rp)
      call inilyr(jdocr(iogrp),0._rp)
    endif
    if (use_DOMclasses .and. use_pref_tracers) then
      call inilyr(jprefdoc(iogrp),0._rp)
      call inilyr(jprefdocsl(iogrp),0._rp)
      call inilyr(jprefdocsr(iogrp),0._rp)
      call inilyr(jprefdocr(iogrp),0._rp)
    endif
    call inilvl(jlvldic(iogrp),0._rp)
    call inilvl(jlvlalkali(iogrp),0._rp)
    call inilvl(jlvlphosy(iogrp),0._rp)
    call inilvl(jlvlnutlim_fe(iogrp),0._rp)
    call inilvl(jlvlnutlim_n(iogrp),0._rp)
    call inilvl(jlvlnutlim_phosph(iogrp),0._rp)
    call inilvl(jlvlphosph(iogrp),0._rp)
    call inilvl(jlvloxygen(iogrp),0._rp)
    call inilvl(jlvlano3(iogrp),0._rp)
    call inilvl(jlvlsilica(iogrp),0._rp)
    call inilvl(jlvldoc(iogrp),0._rp)
    call inilvl(jlvlphyto(iogrp),0._rp)
    call inilvl(jlvlgrazer(iogrp),0._rp)
    call inilvl(jlvlpoc(iogrp),0._rp)
    call inilvl(jlvlcalc(iogrp),0._rp)
    call inilvl(jlvlopal(iogrp),0._rp)
    call inilvl(jlvliron(iogrp),0._rp)
    call inilvl(jlvlco3(iogrp),0._rp)
    call inilvl(jlvlph(iogrp),0._rp)
    call inilvl(jlvlomegaa(iogrp),0._rp)
    call inilvl(jlvlomegac(iogrp),0._rp)
    call inilvl(jlvln2o(iogrp),0._rp)
    call inilvl(jlvlo2sat(iogrp),0._rp)
    call inilvl(jlvldicsat(iogrp),0._rp)
    if (use_pref_tracers) then
      call inilvl(jlvlprefo2(iogrp),0._rp)
      call inilvl(jlvlprefpo4(iogrp),0._rp)
      call inilvl(jlvlprefsilica(iogrp),0._rp)
      call inilvl(jlvlprefalk(iogrp),0._rp)
      call inilvl(jlvlprefdic(iogrp),0._rp)
    endif
    if (use_shelfsea_res_time) then
      call inilvl(jlvlshelfage(iogrp),0._rp)
    endif
    if (use_river2omip) then
      call inilvl(jlvltdoc_lc(iogrp),0._rp)
      call inilvl(jlvltdoc_hc(iogrp),0._rp)
    endif
    if (use_cisonew) then
      call inilvl(jlvldic13(iogrp),0._rp)
      call inilvl(jlvldic14(iogrp),0._rp)
      call inilvl(jlvld13c(iogrp),0._rp)
      call inilvl(jlvld14c(iogrp),0._rp)
      call inilvl(jlvlbigd14c(iogrp),0._rp)
      call inilvl(jlvlpoc13(iogrp),0._rp)
      call inilvl(jlvldoc13(iogrp),0._rp)
      call inilvl(jlvlcalc13(iogrp),0._rp)
      call inilvl(jlvlphyto13(iogrp),0._rp)
      call inilvl(jlvlgrazer13(iogrp),0._rp)
      if (use_river2omip) then
        call inilvl(jlvltdoc_lc13(iogrp),0._rp)
        call inilvl(jlvltdoc_hc13(iogrp),0._rp)
      endif
    endif
    if (use_AGG) then
      call inilvl(jlvlnos(iogrp),0._rp)
      call inilvl(jlvlwphy(iogrp),0._rp)
      call inilvl(jlvlwnos(iogrp),0._rp)
      call inilvl(jlvleps(iogrp),0._rp)
      call inilvl(jlvlasize(iogrp),0._rp)
    endif
    if (use_CFC) then
      call inilvl(jlvlcfc11(iogrp),0._rp)
      call inilvl(jlvlcfc12(iogrp),0._rp)
      call inilvl(jlvlsf6(iogrp),0._rp)
    endif
    if (use_natDIC) then
      call inilvl(jlvlnatco3(iogrp),0._rp)
      call inilvl(jlvlnatalkali(iogrp),0._rp)
      call inilvl(jlvlnatdic(iogrp),0._rp)
      call inilvl(jlvlnatcalc(iogrp),0._rp)
      call inilvl(jlvlnatph(iogrp),0._rp)
      call inilvl(jlvlnatomegaa(iogrp),0._rp)
      call inilvl(jlvlnatomegac(iogrp),0._rp)
    endif
    if (use_BROMO) then
      call inilvl(jlvlbromo(iogrp),0._rp)
    endif
    if (use_extNcycle) then
      call inilvl(jlvlanh4(iogrp),0._rp)
      call inilvl(jlvlano2(iogrp),0._rp)
      call inilvl(jlvl_nitr_NH4(iogrp),0._rp)
      call inilvl(jlvl_nitr_NO2(iogrp),0._rp)
      call inilvl(jlvl_nitr_N2O_prod(iogrp),0._rp)
      call inilvl(jlvl_nitr_NH4_OM(iogrp),0._rp)
      call inilvl(jlvl_nitr_NO2_OM(iogrp),0._rp)
      call inilvl(jlvl_denit_NO3(iogrp),0._rp)
      call inilvl(jlvl_denit_NO2(iogrp),0._rp)
      call inilvl(jlvl_denit_N2O(iogrp),0._rp)
      call inilvl(jlvl_DNRA_NO2(iogrp),0._rp)
      call inilvl(jlvl_anmx_N2_prod(iogrp),0._rp)
      call inilvl(jlvl_anmx_OM_prod(iogrp),0._rp)
      call inilvl(jlvl_phosy_NH4(iogrp),0._rp)
      call inilvl(jlvl_phosy_NO3(iogrp),0._rp)
      call inilvl(jlvl_remin_aerob(iogrp),0._rp)
      call inilvl(jlvl_remin_sulf(iogrp),0._rp)
    endif
    if (use_M4AGO) then
      !  M4AGO
      call inilvl(jlvl_agg_ws(iogrp),0._rp)
      call inilvl(jlvl_dynvis(iogrp),0._rp)
      call inilvl(jlvl_agg_stick(iogrp),0._rp)
      call inilvl(jlvl_agg_stickf(iogrp),0._rp)
      call inilvl(jlvl_agg_dmax(iogrp),0._rp)
      call inilvl(jlvl_agg_avdp(iogrp),0._rp)
      call inilvl(jlvl_agg_avrhop(iogrp),0._rp)
      call inilvl(jlvl_agg_avdC(iogrp),0._rp)
      call inilvl(jlvl_agg_df(iogrp),0._rp)
      call inilvl(jlvl_agg_b(iogrp),0._rp)
      call inilvl(jlvl_agg_Vrhof(iogrp),0._rp)
      call inilvl(jlvl_agg_Vpor(iogrp),0._rp)
    endif
    if (use_DOMclasses) then
      call inilvl(jlvldocsl(iogrp),0._rp)
      call inilvl(jlvldocsr(iogrp),0._rp)
      call inilvl(jlvldocr(iogrp),0._rp)
    endif
    if (use_DOMclasses .and. use_pref_tracers) then
      call inilvl(jlvlprefdoc(iogrp),0._rp)
      call inilvl(jlvlprefdocsl(iogrp),0._rp)
      call inilvl(jlvlprefdocsr(iogrp),0._rp)
      call inilvl(jlvlprefdocr(iogrp),0._rp)
    endif

    if (.not. use_sedbypass) then
      call inisdm(jpowaic(iogrp),0._rp)
      call inisdm(jpowaal(iogrp),0._rp)
      call inisdm(jpowaph(iogrp),0._rp)
      call inisdm(jpowaox(iogrp),0._rp)
      call inisdm(jpown2(iogrp),0._rp)
      call inisdm(jpowno3(iogrp),0._rp)
      call inisdm(jpowasi(iogrp),0._rp)
      call inisdm(jssso12(iogrp),0._rp)
      call inisdm(jssssil(iogrp),0._rp)
      call inisdm(jsssc12(iogrp),0._rp)
      call inisdm(jssster(iogrp),0._rp)

      call inibur(jburssso12(iogrp),0._rp)
      call inibur(jbursssc12(iogrp),0._rp)
      call inibur(jburssssil(iogrp),0._rp)
      call inibur(jburssster(iogrp),0._rp)
      if (use_extNcycle) then
        call inisdm(jpownh4(iogrp),0._rp)
        call inisdm(jpown2o(iogrp),0._rp)
        call inisdm(jpowno2(iogrp),0._rp)
        call inisdm(jsdm_nitr_NH4(iogrp),0._rp)
        call inisdm(jsdm_nitr_NO2(iogrp),0._rp)
        call inisdm(jsdm_nitr_N2O_prod(iogrp),0._rp)
        call inisdm(jsdm_nitr_NH4_OM(iogrp),0._rp)
        call inisdm(jsdm_nitr_NO2_OM(iogrp),0._rp)
        call inisdm(jsdm_denit_NO3(iogrp),0._rp)
        call inisdm(jsdm_denit_NO2(iogrp),0._rp)
        call inisdm(jsdm_denit_N2O(iogrp),0._rp)
        call inisdm(jsdm_DNRA_NO2(iogrp),0._rp)
        call inisdm(jsdm_anmx_N2_prod(iogrp),0._rp)
        call inisdm(jsdm_anmx_OM_prod(iogrp),0._rp)
        call inisdm(jsdm_remin_aerob(iogrp),0._rp)
        call inisdm(jsdm_remin_sulf(iogrp),0._rp)
      else
        call inisdm(jsdm_rem_aerob(iogrp),0._rp)
        call inisdm(jsdm_rem_denit(iogrp),0._rp)
        call inisdm(jsdm_rem_sulf(iogrp),0._rp)
      endif
      if (use_sediment_quality) then
        call inisdm(jsdm_qual_a(iogrp),0._rp)
        call inisdm(jsdm_qual_k(iogrp),0._rp)
        call inisdm(jsdm_qual_app(iogrp),0._rp)
        call inisdm(jsdm_ssso12_age(iogrp),0._rp)
      endif
    endif
    nacc_bgc(iogrp)=0
  ...
  subroutine hamoccvardef(iogrp,timeunits,calendar,cmpflg)
    ...
    use mo_bgcmean,     only: srf_kwco2,srf_fco2,srf_pco2,srf_xco2,srf_pco2_gex,srf_dmsflux,       &
                              ...
                              lvl_calc13,lvl_phyto13,lvl_grazer13,                                 &
                              lyr_docsl,lyr_docsr,lyr_docr,lvl_docsl,lvl_docsr,lvl_docr,           &
                              ...
                              lyr_tdoc_lc,lyr_tdoc_hc,lvl_tdoc_lc,lvl_tdoc_hc,lyr_tdoc_lc13,       &
                              lyr_tdoc_hc13,lvl_tdoc_lc13,lvl_tdoc_hc13,                           &
                              lyr_agg_ws,lyr_dynvis,lyr_agg_stick,                                 &
                              lyr_agg_stickf,lyr_agg_dmax,lyr_agg_avdp,                            &
                              lyr_agg_avrhop,lyr_agg_avdC,lyr_agg_df,                              &
                              lyr_agg_b,lyr_agg_Vrhof,lyr_agg_Vpor,                                &
    ...
    if (use_DOMclasses) then
      ...
      call ncdefvar3d(INT_DOCL_REM(iogrp),cmpflg,'p','docl_remint',             &
           &   'Integrated DOC-L remin',' ','mol C m-2 s-1',0)
      call ncdefvar3d(INT_DOCSL_REM(iogrp),cmpflg,'p','docsl_remint',           &
           &   'Integrated DOC-SL remin',' ','mol C m-2 s-1',0)
      call ncdefvar3d(INT_DOCSR_REM(iogrp),cmpflg,'p','docsr_remint',           &
           &   'Integrated DOC-SR remin',' ','mol C m-2 s-1',0)
      call ncdefvar3d(INT_DOCR_REM(iogrp),cmpflg,'p','docr_remint',             &
           &   'Integrated DOC-R remin',' ','mol C m-2 s-1',0)
    endif
    ...
    if (use_cisonew) then
      ...
      if (use_river2omip) then
        call ncdefvar3d(LYR_TDOC_LC13(iogrp),cmpflg,'p','tdoc_lc13',            &
             &  'Low-C terrestrial dissolved organic carbon13',' ','mol P m-3',1)
        call ncdefvar3d(LYR_TDOC_HC13(iogrp),cmpflg,'p','tdoc_hc13',            &
             &  'High-C terrestrial dissolved organic carbon13',' ','mol P m-3',1)
      endif
    endif
    if (use_AGG) then
    ...
    if (use_river2omip) then
      call ncdefvar3d(LYR_TDOC_LC(iogrp),cmpflg,'p','tdoc_lc',                  &
           &  'Low-C terrestrial dissolved organic carbon',' ','mol P m-3',1)
    ...
    if (use_DOMclasses .and. use_pref_tracers) then
      ...
      call ncdefvar3d(LYR_PREFDOCSL(iogrp),cmpflg,'p',                          &
           &   'p_docsl','Preformed semi-labile DOC',' ','mol P m-3',1)
      call ncdefvar3d(LYR_PREFDOCSR(iogrp),cmpflg,'p',                          &
           &   'p_docsr','Preformed semi-refractory DOC',' ','mol P m-3',1)
      call ncdefvar3d(LYR_PREFDOCR(iogrp),cmpflg,'p',                           &
           &   'p_docr','Preformed refractory DOC',' ','mol P m-3',1)
    endif
    ...
    if (use_cisonew) then
      ...
      if (use_river2omip) then
        call ncdefvar3d(LVL_TDOC_LC13(iogrp),cmpflg,'p','tdoc_lc13lvl',         &
             &  'Low-C terrestrial dissolved organic carbon13',' ','mol P m-3',2)
        call ncdefvar3d(LVL_TDOC_HC13(iogrp),cmpflg,'p','tdoc_hc13lvl',         &
             &  'High-C terrestrial dissolved organic carbon13',' ','mol P m-3',2)
      endif
    endif
    if (use_AGG) then
    ...
    if (use_river2omip) then
      call ncdefvar3d(LVL_TDOC_LC(iogrp),cmpflg,'p','tdoc_lclvl',               &
           &  'Low-C terrestrial dissolved organic carbon',' ','mol P m-3',2)
    ...
    if (use_DOMclasses .and. use_pref_tracers) then
      ...
      call ncdefvar3d(LVL_PREFDOCSL(iogrp),cmpflg,'p',                          &
           &   'p_docsllvl','Preformed semi-labile DOC',' ','mol P m-3',2)
      call ncdefvar3d(LVL_PREFDOCSR(iogrp),cmpflg,'p',                          &
           &   'p_docsrlvl','Preformed semi-refractory DOC',' ','mol P m-3',2)
      call ncdefvar3d(LVL_PREFDOCR(iogrp),cmpflg,'p',                           &
           &   'p_docrlvl','Preformed refractory DOC',' ','mol P m-3',2)
    endif
